/**
  ...
  * @license MIT
  */
"use strict";var e=require("node:fs"),t=require("node:module"),n=require("node:child_process");function i(e){
/**
  * extendString v1.0.0
  * (c) 2018-2022 ymc
  * @license MIT
...
/**
  ...
  * @license MIT
  */
class y{constructor(e,t){this.init(e,t)}async read(t={}){const{file:n}=this;let i,r;try{i=e.createReadStream(n.name),r=await c(i),r=JSON.parse(r)}catch(e){r=t}return n.data=r,r}async write(t){const{file:n,option:i}=this;let r,o=t;try{r=e.createWriteStream(n.name),t?n.data=t:o=n.data,await l({stream:r,data:JSON.stringify(o,null,2)})}catch(e){}}init(e="package.json",t={}){this.file={name:e,data:t},this.option={}}new(...e){return new y(...e)}}new y;const{log:D}=console;module.exports=async function(e={}){const n={pkgLoc:"./pacakges/noop",pnpmCmd:"pnpm add --filter",pkgSrcLoc:"src",...e},{pkgLoc:r,pkgSrcLoc:o}=n,s=function(e,t="/"){const n=e.split(/\/?\\|\//);return n.slice(0,n.length-1).join(t)}(r),c=function(e,t={}){let n=function(e){const t=e.split(/\/?\\|\//);return t[t.length-1]}(e);const r={trim:!0,...t};return r.trim&&(n=n.trim()),r.camelize&&(n=i(n)),n}(r);D("[info] get file list at loc"),D(`[info] loc:${r}/${o} `);const l=a(`${r}/${o}`);D("[info] get nodejs built in module");const p=function(){const e=["sys"];return(t.builtinModules||(process.binding?Object.keys(process.binding("natives")):[])||[]).filter((t=>!/^_|^(internal|v8|node-inspect)\/|\//.test(t)&&!e.includes(t))).sort()}();D("[info] get dep list of out-lib at loc");const u=l.map((async e=>{const t=new f;return t.option.nodedeps=p,t.option.ignoreComment=!0,await t.parse(e),t.outlibDeps}));let d,m=await Promise.all(u);var g,y;
/**
  * runBash v0.0.3
  * (c) 2018-2022 ymc
  * @license MIT
  */m=[...new Set(m.flat(1))],D(m),m&&m.length>0&&(g=`${n.pnpmCmd} {libdir}/{libname} ${m.join(" ")}`,d=(y={libdir:s,libname:c})?h(g,y):e=>h(g,e),D(`[info] cmd:${d}`),await async function(e,t){const{stdout:n}=await b(e,t);return n}(d,w))};
