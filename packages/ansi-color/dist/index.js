...
const create = () => {
    ...
    colors$1.hasColor = colors$1.hasAnsi = hasAnsi(colors$1);

    // desc: define color or alias
    colors$1.alias = defineAlias(colors$1);

    // desc: define color theme
    colors$1.theme = defineTheme(colors$1);
...
export { create, instance as default };
