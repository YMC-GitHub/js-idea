...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.changeset = {}, global.node_fs));
...
`;
  ...
  function getVersionTypeInChangeset(s, libname) {
    ...
    match = s.match(reg); // log(reg, match);
  ...
  function parseChangeset(s) {
    // front,body
    const menifest = splitLines(s); // get front label s and e positon
