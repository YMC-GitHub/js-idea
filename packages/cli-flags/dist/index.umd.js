...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["cli-flags"] = {}));
  ...
  function stylizeFlags(flags = {}, options = {}) {
    ...
    if (option[camelize(`noAuto-${options.style}`)]) return flags; // typeof ''[options.style]==="function"

    Object.keys(flags).forEach(str => {
      const ck = stylize(str); // res[ck]=flags[k]
  ...
  function underscopedFlags(flags = {}, options = {}) {
    return stylizeFlags(flags, { ...options,
      style: 'underscoped',
      styleHandle: underscoped
    });
  }

  exports.camelizeFlags = camelizeFlags;
  exports.stylizeFlags = stylizeFlags;
  exports.underscopedFlags = underscopedFlags;
