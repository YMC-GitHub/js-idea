/**
  ...
  * @license MIT
  */
"use strict";function t(t,e={}){let n={};const i=Object.keys(t).map((e=>t[e])),s={slim:!0,modeStyle:"cli",...e};"string"===s.mode&&(s.slim=!0);for(let t=0;t<i.length;t+=1){const e=i[t],{name:r,type:o,value:l,desc:a}=e,[p,c]=r.split(/,/).map((t=>t.trim().replace(/^-*/gi,""))),u=p.length>1?p:c;if(u){if(s.noAutoCamelize||(n[u.camelize()]=l),s.slim)continue;n[u]=l}n[p]=l}return"string"===s.mode&&(n=function(t,e){const n={modeStyle:"cli",...e};let i="";return"string"===n.mode&&"cli"===n.modeStyle&&(i=Object.keys(t).map((e=>e.length>1?`--${e}=${t[e]}`:`-${e}=${t[e]}`)).join(" ")),"string"===n.mode&&"httpquery"===n.modeStyle&&(i=Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&")),"string"===n.mode&&"swithoption"===n.modeStyle&&(i=Object.keys(t).map((e=>`${e}=${t[e]}`)).join(";")),i}(n,s)),n}function e(t={},e={}){const n={slim:!0,...e};return n.noAutoCamelize||Object.keys(t).forEach((e=>{const i=
/**
  * cliParam v1.0.0
  * (c) 2018-2022 ymc
  * @license MIT
