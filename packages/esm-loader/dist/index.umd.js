...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node:path'), require('node:url'), require('node:fs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'node:path', 'node:url', 'node:fs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["esm-loader"] = {}, global.node_path, global.node_url, global.node_fs));
})(this, (function (exports, node_path, node_url, node_fs) { 'use strict';
