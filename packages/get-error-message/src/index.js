...
function getErrorMessage(err, status, env) {
    ...
    // https://github.com/oliver-moran/jimp/blob/master/packages/plugins/src/index.js
    // addJimpMethods,addConstants
    return msg || this.statusMessage[status]
    // return msg || this.getDatabase('status')[status]
    // return msg || this.getDatabase('statusMessage')[status]
    // return msg || this.getDatabase('data','status')[status]
}
