...
import { isValidType, isDefine, toArray, fixmsg } from './tools'
import './types'
/**
 * get type in subject
...
function parse(msg, msgb, allowTypes) {
    ...
    const standardBody = parseMsgBody(body)
    // console.log(subject, body, standardBody);
...
export { getTypeInSubject, getScopeInSubject, parseMsgBody, getIssueInFoot, parse }
