...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["run-bash"] = {}, global.node_child_process));
  ...
  const setExecOptsForIconv = (iconv, execOpts) => {
    ...
    execOpts.iconvDesEncoding = 'cp936';
    execOpts.iconvSrcEncoding = 'binary'; // execOpts.fixUnreadbleCode = fixUnreadbleCode;

    execOpts.fixUnreadbleCode = defFixUnreadbleCode(iconv); // res = await exec(`dir`, execOpts);
  };
  ...
  exports.defFixUnreadbleCode = defFixUnreadbleCode;
  exports.exec = execWraper;
  exports.execOpts = execOpts;
  exports.setExecOptsForIconv = setExecOptsForIconv;
