...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["switch-option"] = factory());
  ...
  function switchOption(option = {}, list = '', def = true) {
    list.split(';').forEach(exp => {
      ...
      const defined = isDefine(val); // emptyString?
  ...
  function isBoolString(s, v = 'false') {
    // console.log(s);
    return s.toLowerCase() === v; // another case
    // let d = s.toLowerCase();
